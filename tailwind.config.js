  ...
  theme: {
    extend: {
      colors: {
        ...
        'comun-teal':    '#5BB8D4',
        'comun-gold':    '#FFD000',
        'comun-gold-light': '#FFE266',
        'comun-gold-dark':  '#C9A300',
        // Brand maroon — secondary accent
        'comun-maroon':       '#912626',
        'comun-maroon-light': '#B83A3A',
        'comun-maroon-dark':  '#5E1717',
        'comun-white':   '#F5F0E8',
        'comun-muted':   '#8a8a8a',
        'comun-orange':  '#D4722A',
      ...
      backgroundImage: {
        'gold-gradient':  'linear-gradient(135deg, #FFD000 0%, #FFE266 50%, #C9A300 100%)',
        'dark-gradient':  'linear-gradient(180deg, #0a0a0a 0%, #0d1b2a 50%, #0a0a0a 100%)',
        'radial-gold':    'radial-gradient(ellipse at center, rgba(255,208,0,0.15) 0%, transparent 70%)',
      ...
      boxShadow: {
        'gold':     '0 0 40px rgba(255,208,0,0.25)',
        'gold-sm':  '0 0 20px rgba(255,208,0,0.15)',
        'gold-lg':  '0 0 80px rgba(255,208,0,0.3)',
